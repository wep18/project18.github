...
setCelepration(e.target.value);}
 const sentCelepration = async()=>{
      if(celepration1){
            const celeprationcol=collection(db,"celepration");
...
<textarea className="form-control" id="floatingTextarea2"  placeholder={props.labelname1} required value={celepration1} onChange={data} ></textarea>
...
export default CeleprationInput;